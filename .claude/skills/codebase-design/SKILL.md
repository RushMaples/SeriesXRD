...
description: Shared vocabulary for designing deep modules — a lot of behaviour behind a small interface, placed at a clean seam, testable through that interface.
...
- **"Interface" as just the type signature**: too narrow — interface here includes every fact a caller must know.
