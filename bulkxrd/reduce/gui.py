...
class ReductionApp:
    def __init__(self, config_path: "str | Path", parent=None):
        ...
        if parent is None:
            ...
            self.root = tk.Tk()
            self.root.title(f"{TOOL_NAME} Batch Reduction")
    ...
    def _build_gui(self):
        ...
        ttk.Label(topbar, text=f"{TOOL_NAME} Batch Reduction", font=("TkDefaultFont", 14, "bold")).pack(side="left")
    ...
    def _open_config_dialog(self):
        try:
            ...
            self.messagebox.showinfo(
                ...
                f'python -m bulkxrd.reduce.run_gui --config "{path}"\n\nSelected:\n{path}')
        except Exception as e:
