...
ramp encoding pressure. ``bulkxrd-stack`` / the Frame-meta export dialog's
...
* **exclude_d** — optional list of d-spacings (Angstrom) whose windows
  ...
  the 1D analog of ``bulkxrd-spots --exclude-d`` for known contaminant
...
def main(argv: "list[str] | None" = None) -> int:
    """CLI: ``bulkxrd-stack analysis.h5 out.png [options]``."""
    import argparse
