...
# Works both as a package module (python -m seriesxrd.analysis.worker) and as a
...
if __package__ in (None, ""):
    ...
    from seriesxrd.analysis.frame_metadata import import_csv_to_analysis
    from seriesxrd.analysis.ml_rank import rank_candidates
    from seriesxrd.analysis.unknowns import run_unknowns
else:
        ...
        if run_ml_rank:
            if not pymatgen_available():
                ...
                mrank = rank_candidates(
                    ...
                    # seriesxrd-ml-train export (see docs/ml-training.md).
