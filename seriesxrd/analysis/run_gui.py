...
Runnable three ways:
    seriesxrd-analysis-gui --config <path>          (console script, pip install)
    python -m seriesxrd.analysis.run_gui --config <path>
    python seriesxrd/analysis/run_gui.py --config <path>
"""
...
def main() -> int:
    ...
    if args.config:
        ...
        if cfg is None:
            ...
            print("", flush=True)
            print("Run with:  python -m seriesxrd.analysis.run_gui --config <path_to_config>", flush=True)
            return 1
