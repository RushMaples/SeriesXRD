...
* :class:`TorchScorer` — adapter for a trained model (``seriesxrd[ml]``). Loads a
...
class TorchScorer(PhaseScorer):
    """Adapter for a trained (RADAR-PD-style) scorer behind ``seriesxrd[ml]``.
    ...
    def __init__(self, model_path: "str | Path", *, fwhm_d: float = 0.03,
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Install the optional extra with `pip install seriesxrd[ml]`, or use "
